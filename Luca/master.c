...
int main() {
  ...
  char * arg_list_1[] = { "/usr/bin/konsole",  "-e", "./k1", (char*)NULL }; //argv[] argument that need to be passed to the function "execvp" in order to execute the executable
  //"tobexecuted" in a new konsole with argument 10
  char * arg_list_2[] = { "/usr/bin/konsole",  "-e", "./k2", (char*)NULL };
  char * arg_list_3[] = { "/usr/bin/konsole",  "-e", "./motor_x", (char*)NULL };
  char * arg_list_4[] = { "/usr/bin/konsole",  "-e", "./motor_z", (char*)NULL };
  int pid1;
  int pid2;
  int pid3;
  int pid4;
